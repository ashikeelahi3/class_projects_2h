...
9 & 10 & 11 & 12
\end{bmatrix}
$$ Also find (a) row sum, (b) column sum, and (c) the element in (2, 3) position.
...
plot(dosage, drugA, type="b", pch=15, lty=1, col="red",
     ylim = c(0, 60), main = "Drug A vs. Drug B", 
     xlab ="Drug Dosage", ylab = "Drug Response")
lines(dosage, drugB, type = "b", pch=17, lty=2, col="blue")
abline(h=c(30), lwd=1.5, lty=2, col="gray")
legend("topleft", inset = 0.05, title = "Drug Type", c("A", "B"), lty=c(1, 2), col = c("red", "blue"), pch = c(15, 17))
```
